...
exports.getAllSoutenances = (req, res) => {
    const sql = `
        ...
        LEFT JOIN professors AS president ON soutenances.presidentId = president.id
        LEFT JOIN professors AS rapporteur ON soutenances.rapporteurId = rapporteur.id
        LEFT JOIN professors AS encadrant ON soutenances.encadrantId = encadrant.id
    `;
